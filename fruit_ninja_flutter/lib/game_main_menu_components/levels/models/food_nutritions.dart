...
class FoodNutritions {
  ...
  FoodNutritions ({required this.id, required double water, required double energy, required double protein,
  ...
  factory FoodNutritions.fromSqfliteDatabase(Map<String, dynamic> map) => FoodNutritions(
      id: map['ID']?.toInt() ?? 0,
      water: map['water'] ?? 0,
      energy: map['energy'] ?? 0,
