...
class CanvasAreaLevel_02 extends StatefulWidget {
  final int level;

  const CanvasAreaLevel_02({Key? key, required this.level})
...
class _CanvasAreaState extends State<CanvasAreaLevel_02>
